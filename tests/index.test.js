...
describe("Authenticaiton", () => {
  test('user is able to signup only once', async () => {
    ...
    const updatedResponse = await axios.post(`${BACKEND_URL}/api/v1/authorization/signup`, {
      username,
      password,
      type: 'admin'
    })
  ...
  test('Signin succeeds if the username and password are correct', async () => {
    ...
    await axios.post(`${BACKEND_URL}/api/v1/authorization/signup`, {
      username,
      password,
      type: "admin"
    });

    const response = await axios.post(`${BACKEND_URL}/api/v1/authorization/signin`, {
      username,
      password
    })
